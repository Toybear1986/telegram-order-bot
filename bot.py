...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        "1. Перейдите в бота по ссылке или отсканируйте QR-код.\n"
        "2. Нажмите /start или просто отправьте любое сообщение.\n"
        "3. Выберите категорию (например, «Бургеры» или «Коктейли»).\n"
        "4. Тапайте на понравившиеся позиции, указывайте количество.\n"
        "5. Когда всё готово – загляните в корзину и нажмите «Заказать».\n"
        "6. По желанию оставьте комментарий.\n"
        "7. Готово! Ваш заказ уже у персонала, а вы получаете подтверждение.\n\n"
